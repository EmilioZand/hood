...
export async function Header() {
  ...
  // Anonymous visitors get the same read-only browsing surface an approved user does
  // (spots list + search); only the write actions below are gated.
  const canBrowse = !user || (profile?.isApproved ?? false);
